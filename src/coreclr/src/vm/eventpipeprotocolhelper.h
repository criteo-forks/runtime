...
// Command = 0x0204
struct EventPipeCollectTracing3CommandPayload
{
    ...
    bool stacksRequested;
    CQuickArray<EventPipeProviderConfiguration> providerConfigs;
    static const EventPipeCollectTracing3CommandPayload* TryParse(BYTE* lpBuffer, uint16_t& BufferSize);
};
...
public:
    ...
    static void CollectTracing3(DiagnosticsIpc::IpcMessage& message, IpcStream *pStream);
